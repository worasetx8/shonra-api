...
async function migrate() {
  try {
    ...
    const hasCategories =
      checkCategories.success &&
      checkCategories.data &&
      checkCategories.data[0] &&
    ...
    const categoriesResult = await executeQuery("SELECT id, name FROM categories WHERE is_active = 1");
    ...
    for (const category of categories) {
      ...
      if (
        catNameLower.includes("อิเล็กทรอนิก") ||
        catNameLower.includes("electronic") ||
        catNameLower.includes("tech") ||
        catNameLower.includes("คอมพิวเตอร์")
      ) {
        keywordsData = categoryKeywordsMap.electronics;
      } else if (
        catNameLower.includes("แฟชั่น") ||
        catNameLower.includes("fashion") ||
        catNameLower.includes("เสื้อผ้า") ||
        catNameLower.includes("clothing") ||
        catNameLower.includes("apparel") ||
        catNameLower.includes("accessories") ||
        catNameLower.includes("accessory")
      ) {
        keywordsData = categoryKeywordsMap.fashion;
      } else if (
        catNameLower.includes("ความงาม") ||
        catNameLower.includes("beauty") ||
        catNameLower.includes("เครื่องสำอาง") ||
        catNameLower.includes("cosmetic") ||
        catNameLower.includes("skincare") ||
        catNameLower.includes("health") ||
        catNameLower.includes("สุขภาพ")
      ) {
        keywordsData = categoryKeywordsMap.beauty;
      } else if (
        catNameLower.includes("บ้าน") ||
        catNameLower.includes("home") ||
        catNameLower.includes("living") ||
        catNameLower.includes("เฟอร์นิเจอร์") ||
        catNameLower.includes("furniture")
      ) {
        keywordsData = categoryKeywordsMap.home;
      } else if (
        catNameLower.includes("ครอบครัว") ||
        catNameLower.includes("family") ||
        catNameLower.includes("เด็ก") ||
        catNameLower.includes("baby") ||
        catNameLower.includes("kid") ||
        catNameLower.includes("children")
      ) {
        keywordsData = categoryKeywordsMap.family;
      } else if (
        catNameLower.includes("ของเล่น") ||
        catNameLower.includes("toy") ||
        catNameLower.includes("pet") ||
        catNameLower.includes("สัตว์เลี้ยง") ||
        catNameLower.includes("pets")
      ) {
